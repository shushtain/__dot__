...
xkb_symbols "shush" {
    ...
    name[Group1]= "English (Shush)";

       	key <AE01> { [ 1, U0021, U2018, U201c ] }; // DIGIT ONE, EXCLAMATION MARK, <none>, LEFT SINGLE QUOTATION MARK, LEFT DOUBLE QUOTATION MARK
	key <AE02> { [ 2, U0040, U2019, U201d ] }; // DIGIT TWO, COMMERCIAL AT, <none>, RIGHT SINGLE QUOTATION MARK, RIGHT DOUBLE QUOTATION MARK
	key <AE03> { [ 3, U0023, U2116, NoSymbol ] }; // DIGIT THREE, NUMBER SIGN, <none>, NUMERO SIGN, <none>
	key <AE04> { [ 4, U0024, NoSymbol, NoSymbol ] }; // DIGIT FOUR, DOLLAR SIGN, <none>, <none>, <none>
	key <AE05> { [ 5, U0025, NoSymbol, NoSymbol ] }; // DIGIT FIVE, PERCENT SIGN, <none>, <none>, <none>
	key <AE06> { [ 6, U005e, NoSymbol, NoSymbol ] }; // DIGIT SIX, CIRCUMFLEX ACCENT, <none>, <none>, <none>
	key <AE07> { [ 7, U0026, NoSymbol, NoSymbol ] }; // DIGIT SEVEN, AMPERSAND, <none>, <none>, <none>
	key <AE08> { [ 8, U002a, U00b7, U2022 ] }; // DIGIT EIGHT, ASTERISK, <none>, MIDDLE DOT, BULLET
	key <AE09> { [ 9, U0028, NoSymbol, NoSymbol ] }; // DIGIT NINE, LEFT PARENTHESIS, <none>, <none>, <none>
	key <AE10> { [ 0, U0029, NoSymbol, NoSymbol ] }; // DIGIT ZERO, RIGHT PARENTHESIS, <none>, <none>, <none>
	key <AE11> { [ U002d, U005f, U2013, U2014 ] }; // HYPHEN-MINUS, LOW LINE, <none>, EN DASH, EM DASH
	key <AE12> { [ U003d, U002b, U2212, U00f7 ] }; // EQUALS SIGN, PLUS SIGN, <none>, MINUS SIGN, DIVISION SIGN
	key <AD01> { [ q, Q, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER Q, LATIN CAPITAL LETTER Q, <none>, <none>, <none>
	key <AD02> { [ w, W, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER W, LATIN CAPITAL LETTER W, <none>, <none>, <none>
	key <AD03> { [ e, E, U20ac, NoSymbol ] }; // LATIN SMALL LETTER E, LATIN CAPITAL LETTER E, <none>, EURO SIGN, <none>
	key <AD04> { [ r, R, U00ae, NoSymbol ] }; // LATIN SMALL LETTER R, LATIN CAPITAL LETTER R, <none>, REGISTERED SIGN, <none>
	key <AD05> { [ t, T, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER T, LATIN CAPITAL LETTER T, <none>, <none>, <none>
	key <AD06> { [ y, Y, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER Y, LATIN CAPITAL LETTER Y, <none>, <none>, <none>
	key <AD07> { [ u, U, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER U, LATIN CAPITAL LETTER U, <none>, <none>, <none>
	key <AD08> { [ i, I, U2191, NoSymbol ] }; // LATIN SMALL LETTER I, LATIN CAPITAL LETTER I, <none>, UPWARDS ARROW, <none>
	key <AD09> { [ o, O, U00b0, U2300 ] }; // LATIN SMALL LETTER O, LATIN CAPITAL LETTER O, <none>, DEGREE SIGN, DIAMETER SIGN
	key <AD10> { [ p, P, U00a3, NoSymbol ] }; // LATIN SMALL LETTER P, LATIN CAPITAL LETTER P, <none>, POUND SIGN, <none>
	key <AD11> { [ U005b, U007b, NoSymbol, NoSymbol ] }; // LEFT SQUARE BRACKET, LEFT CURLY BRACKET, ESCAPE, <none>, <none>
	key <AD12> { [ U005d, U007d, NoSymbol, NoSymbol ] }; // RIGHT SQUARE BRACKET, RIGHT CURLY BRACKET, INFORMATION SEPARATOR THREE, <none>, <none>
	key <AC01> { [ a, A, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER A, LATIN CAPITAL LETTER A, <none>, <none>, <none>
	key <AC02> { [ s, S, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER S, LATIN CAPITAL LETTER S, <none>, <none>, <none>
	key <AC03> { [ d, D, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER D, LATIN CAPITAL LETTER D, <none>, <none>, <none>
	key <AC04> { [ f, F, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER F, LATIN CAPITAL LETTER F, <none>, <none>, <none>
	key <AC05> { [ g, G, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER G, LATIN CAPITAL LETTER G, <none>, <none>, <none>
	key <AC06> { [ h, H, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER H, LATIN CAPITAL LETTER H, <none>, <none>, <none>
	key <AC07> { [ j, J, U2190, NoSymbol ] }; // LATIN SMALL LETTER J, LATIN CAPITAL LETTER J, <none>, LEFTWARDS ARROW, <none>
	key <AC08> { [ k, K, U2193, NoSymbol ] }; // LATIN SMALL LETTER K, LATIN CAPITAL LETTER K, <none>, DOWNWARDS ARROW, <none>
	key <AC09> { [ l, L, U2192, NoSymbol ] }; // LATIN SMALL LETTER L, LATIN CAPITAL LETTER L, <none>, RIGHTWARDS ARROW, <none>
	key <AC10> { [ U003b, U003a, NoSymbol, NoSymbol ] }; // SEMICOLON, COLON, <none>, <none>, <none>
	key <AC11> { [ U0027, U0022, NoSymbol, NoSymbol ] }; // APOSTROPHE, QUOTATION MARK, <none>, <none>, <none>
	key <TLDE> { [ U0060, U007e, U20b4, U20b4 ] }; // GRAVE ACCENT, TILDE, <none>, HRYVNIA SIGN, HRYVNIA SIGN
	key <BKSL> { [ U005c, U007c, NoSymbol, NoSymbol ] }; // REVERSE SOLIDUS, VERTICAL LINE, INFORMATION SEPARATOR FOUR, <none>, <none>
	key <AB01> { [ z, Z, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER Z, LATIN CAPITAL LETTER Z, <none>, <none>, <none>
	key <AB02> { [ x, X, U00d7, NoSymbol ] }; // LATIN SMALL LETTER X, LATIN CAPITAL LETTER X, <none>, MULTIPLICATION SIGN, <none>
	key <AB03> { [ c, C, U00a9, NoSymbol ] }; // LATIN SMALL LETTER C, LATIN CAPITAL LETTER C, <none>, COPYRIGHT SIGN, <none>
	key <AB04> { [ v, V, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER V, LATIN CAPITAL LETTER V, <none>, <none>, <none>
	key <AB05> { [ b, B, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER B, LATIN CAPITAL LETTER B, <none>, <none>, <none>
	key <AB06> { [ n, N, NoSymbol, NoSymbol ] }; // LATIN SMALL LETTER N, LATIN CAPITAL LETTER N, <none>, <none>, <none>
	key <AB07> { [ m, M, U2122, U2120 ] }; // LATIN SMALL LETTER M, LATIN CAPITAL LETTER M, <none>, TRADE MARK SIGN, SERVICE MARK
	key <AB08> { [ U002c, U003c, U003c, U00ab ] }; // COMMA, LESS-THAN SIGN, <none>, LESS-THAN SIGN, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK *
	key <AB09> { [ U002e, U003e, U003e, U00bb ] }; // FULL STOP, GREATER-THAN SIGN, <none>, GREATER-THAN SIGN, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK *
	key <AB10> { [ U002f, U003f, U2026, NoSymbol ] }; // SOLIDUS, QUESTION MARK, <none>, HORIZONTAL ELLIPSIS, <none>
	key <SPCE> { [ U0020, U0020, NoSymbol, NoSymbol ] }; // SPACE, SPACE, SPACE, <none>, <none>
	key <LSGT> { [ U005c, U007c, NoSymbol, NoSymbol ] }; // REVERSE SOLIDUS, VERTICAL LINE, INFORMATION SEPARATOR FOUR, <none>, <none>
	key <KPDL> { [ U002e, U002c, NoSymbol, NoSymbol ] }; // FULL STOP, COMMA, , ,
